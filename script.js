...
function changeBackground(condition, isNight) {
  ...
  if (isNight) {
    bg = "clear-night.mp4"; // Night background video URL
    isVideo = true; // Flag to indicate video background
  } else {
    if (condition === "partly-cloudy-day") {
      bg = "cloud-day.mp4"; // Cloudy day video URL
      isVideo = true; // Use video for cloudy day
    } else if (condition === "partly-cloudy-night") {
      bg = "night.mp4"; // Cloudy night video URL
      isVideo = true; // Use video for cloudy night
    } else if (condition === "rain") {
      bg = "rain.mp4"; // Rain video URL
      isVideo = true; // Use video for rain
    } else if (condition === "clear-day") {
      bg = "clear-day.jpg"; // Clear day image URL
    } else if (condition === "Clear-night") {
      bg = "clear-night.jpg"; // Clear night image URL
    } 
    else if (condition === "Overcast") {
      bg = "overcast.mp4"; // Clear night image URL
    }
    else if (condition === "Rain Partially cloudy") {
      bg = "partial-cloudy-rain.mp4"; // Clear night image URL
    } else {
      bg = "sun-rise.mp4"; // Default video URL
      isVideo = true; // Flag to indicate video background
    }
  }
  ...
  if (isVideo) {
    ...
    videoContainer.querySelector("video").src = bg;
  } else {
    backgroundImage.style.display = "block";
    videoContainer.style.display = "none";
    backgroundImage.style.backgroundImage = `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${bg})`;
  }
}
